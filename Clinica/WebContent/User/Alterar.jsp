...
<html>
  ...
  <body>
    <%
      ...
      if (email != null && !email.isEmpty()) {
        if (verifica && !email.equals(email_antigo)) {
          ...
          %>
          <form id="return_Form" action="../index/Logado/Tela_de_Logado.jsp?conf=existe" method="post">
    ...
    %>
    <form id="return_Form" action="../index/Logado/Tela_de_Logado.jsp?conf=altera" method="post">
      <input type="hidden" name="nome_User" id="nome_User" value="<%=nome%>" />
